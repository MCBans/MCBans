...
public class BanSync implements Runnable {
    ...
    public void save() {
        try {
            Writer writer = new OutputStreamWriter(new FileOutputStream("plugins/mcbans/sync.last"), "UTF-8");
    ...
    public void load() {
        ...
        String strLine = "";
        try {
            BufferedReader i = new BufferedReader(new InputStreamReader(new FileInputStream("plugins/mcbans/sync.last"), "UTF8"));
            String line = null;
